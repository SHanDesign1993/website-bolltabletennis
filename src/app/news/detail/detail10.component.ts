...
@Component({
  template:`    
    <div class="big-about">
        ...
        2017/10/03 - 【中秋節營業時間異動】

        </div>	
        <div class="detailimg">
        
        <img src="../../../img/detail10/img1.jpg" height="500px" class="detailbigimg">
        </div>			
        <p class="news_content_wrap">
        中秋節營業時間調整為AM 10:00~ PM 4:00
        祝福大家中秋佳節愉快! 月圓人團圓!
...
export class Detail10Component implements OnInit{
